...
namespace HEAL.Bricks {
  public abstract class Channel : IChannel {
    ...
    public async Task SendMessageAsync(string command, CancellationToken cancellationToken = default) => await SendMessageAsync(Message.Factory.CustomMessage(command), cancellationToken);
    public async Task SendMessageAsync<T>(string command, T payload, CancellationToken cancellationToken = default) => await SendMessageAsync(Message.Factory.CustomMessage(command, payload), cancellationToken);
